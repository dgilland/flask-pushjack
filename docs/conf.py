# -*- coding: utf-8 -*-
#
# flask_pushjack documentation build configuration file, created by
...
version = release = flask_pushjack.__version__
...
htmlhelp_basename = 'flask_pushjackdoc'
